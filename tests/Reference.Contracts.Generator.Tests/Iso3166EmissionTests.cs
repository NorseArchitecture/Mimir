...
public sealed class Iso3166EmissionTests
{
	...
	[Fact]
	void Emits_mimir_namespaces_with_literal_guids()
	{
		var generated = GeneratorTestHarness.Run(Csv);
		generated.ShouldContain("static class MimirNamespaces");
		generated.ShouldContain("public static readonly global::System.Guid Root = new(\"");
